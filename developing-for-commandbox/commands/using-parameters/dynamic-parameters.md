...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/Bw6M3PI3e5HgLVcKZz0G/developing-for-commandbox/commands/using-parameters/dynamic-parameters
---
...
which will create a literal key of `foo:bar.`<br>
